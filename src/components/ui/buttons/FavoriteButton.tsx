...
export default function FavoriteButton({ onBtnClick, additionalClasses, isFavorite }: FavoriteButtonProp){
    return (
        <button
            className={ `ui favorite ${additionalClasses}` }
            onClick={ (event) => {
        ...
        >
            { !isFavorite
                ? <svg className="favorite-icon empty" viewBox="0 0 36 36" version="1.1"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
                ...
                : <svg className="favorite-icon filled" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52" enableBackground="new 0 0 52 52">
