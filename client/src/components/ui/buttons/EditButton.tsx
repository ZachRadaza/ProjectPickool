...
export default function EditButton({ onBtnClick, additionalClasses }: EditButtonProp){
    return (
        <button
            onClick={ () => onBtnClick() }
            className={ `ui edit ${additionalClasses}` }
        >
            <svg className="edit-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" clipRule="evenodd" d="M12 21C12 20.4477 12.4477 20 13 20H21C21.5523 20 22 20.4477 22 21C22 21.5523 21.5523 22 21 22H13C12.4477 22 12 21.5523 12 21Z"/>
