    ...
    return (
        <>
            <div className="popups-cont">
                ...
                />
                <PopupWrapper
                    isClosed={ closedNotifsPopup }
                    popupComp={
                        <NotificationsPopup 
                            setIsClosed={ setClosedNotifsPopup }
                            userHeader={ userHeader }
                            setNumNotifs={ setNumberNotifs }
                        />
                    }
                />
                <PopupWrapper 
            ...
            <main>
                <Header userHeader={ userHeader } numberNotifs={ numberNotifs } setClosedNotifsPopup={ setClosedNotifsPopup }/>
